...
export default function Teachers() {
  ...
  //Extraer los datos de la endpoint /api/tecahers
  useEffect(() => {
    ...
    >
      ...
      >
        <div>
          ...
          >
            Sistema Académico Universitario · {teachers.length} docentes
            registrados
          </p>
        </div>
        <button
      ...
      >
        {[
          ...
          {
            label: "En Licencia",
            value: teachers.filter((t) => t.status === "Licencia").length,
            icon: "📋",
            accent: "#D97706",
          },
        ].map((s, i) => (
                        ...
                        >
                          <div
                            style={{
                              ...
                              fontWeight: 700,
                              fontSize: 13,
                              color: ac[0] === "#FBBF24" ? "#1E3A8A" : "white",
                              flexShrink: 0,
                    ...
                    <div>
                      ...
                      <span
                        style={{
                          ...
                          alignItems: "center",
                          gap: 5,
                          background: statusConfig[selectedTeacher.status]?.bg,
                          color: statusConfig[selectedTeacher.status]?.color,
                          borderRadius: 20,
                          padding: "3px 10px",
                          fontSize: 12,
                          fontWeight: 700,
                      ...
                      >
                        <span
                          style={{
                            ...
                            borderRadius: "50%",
                            background:
                              statusConfig[selectedTeacher.status]?.dot,
                            display: "inline-block",
                          }}
                        />
                ...
                >
                  {[
                    ...
                    },
                    {
                      ...
                      key: "degree",
                      type: "text",
                      placeholder: "Ej. MSc. Ingeniería de Software",
                    },
                  ].map((field) => (
                    <div key={field.key}>
                      <label
