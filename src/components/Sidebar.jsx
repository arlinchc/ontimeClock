  ...
  return (
    ...
    >
      ...
      <div className="flex flex-col gap-4">
        ...
        <div>
          {!isCollapsed && (
            <p className="text-slate-500 text-[11px] mb-2 uppercase tracking-[2px] font-black">
              Sitio
            </p>
          )}
      ...
      {/* FOOTER */}
      <div
        className={`mt-auto pt-6 border-t border-white/10 ${isCollapsed ? "flex justify-center" : ""}`}
      >
        {!isCollapsed ? (
